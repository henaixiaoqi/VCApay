...
if ($conf['qrcode'] == '1') $codepay_config["qrcode_url"] = "./includes/codepay/qrcode.php";
...
if(!is_dir('./includes/codepay')){ //如果存在这个文件 表示codepay目录上传 使用本地资源否则用远程资源
...
<head>
    ...
    <title><?php echo $typeName ?>VCA易支付 - 订单投诉QQ89463869</title>
